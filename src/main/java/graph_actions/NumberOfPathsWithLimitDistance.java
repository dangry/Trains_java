...
public class NumberOfPathsWithLimitDistance implements GraphAction {
    ...
    public int getNumberOfPathsWithLimitDistance(Train train, int pathsCount, String route, int distanceTraveled) {
        ...
        for (Edge edge : currentNode.getEdges().values()) {
            ...
            pathsCount = getNumberOfPathsWithLimitDistance(train, pathsCount, route, distanceTraveled + edge.getLength());
